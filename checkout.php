...
if(isset($_POST['submit'])){
    ...
    if($payment_type=='payu'){
        $MERCHANT_KEY = "I6pXFPf#PzdDEZFp"; 
        $SALT = "eCwWELxi";
        $hash_string = '';
        // $PAYU_BASE_URL = "https://freefrontend.com/bootstrap-payment-forms/";
                            ...
                            <div class="order-details__item">
                                ...
                                <div class="single-item">
                                    <div class="single-item__thumb">
                                        <img src="admin/media/<?php echo $image?>"  />
                                    </div>
